  ...
  <div class="accounts-container">
    <div class="card p-4 sm:p-6">
      <div class="mb-4 flex flex-col gap-4 sm:mb-6">
        <div>
          <h3
            class="mb-1 text-lg font-bold text-gray-900 dark:text-gray-100 sm:mb-2 sm:text-xl"
          >
            账户管理
          </h3>
        ...
        >
          ...
          >
            ...
            <div class="group relative min-w-[200px]">
              ...
              <div class="relative flex items-center">
                ...
                />
                <i
                  class="fas fa-search absolute left-3 text-sm text-cyan-500"
                />
                <button
                  v-if="searchKeyword"
          ...
          <div
            class="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-3"
          >
            <!-- 刷新按钮 -->
            <div class="relative">
              <el-tooltip
            ...
            >
              <i
                :class="showCheckboxes ? 'fas fa-times' : 'fas fa-check-square'"
              ></i>
            ...
            >
              ...
              <span class="relative"
                >删除选中 ({{ selectedAccounts.length }})</span
              >
            </button>
          ...
          <thead class="bg-gray-50/80 backdrop-blur-sm dark:bg-gray-700/80">
            <tr>
              <th
                ...
                class="w-[50px] px-3 py-4 text-left"
              >
              ...
              <th
                class="w-[12%] min-w-[120px] px-3 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300"
              >
                定时任务
              </th>
              <th
                  ...
                  <el-tooltip placement="top">
                    <template #content>
                      ...
                      >
                        <div class="space-y-2">
                          <div
                            class="text-sm font-semibold text-white dark:text-gray-900"
                          >
                            Claude 系列
                          </div>
                          <div class="text-gray-200 dark:text-gray-600">
                            会话窗口进度表示 5
                            小时窗口的时间推移，颜色提示当前调度状态。
                          </div>
                          <div
                            class="space-y-1 pt-1 text-gray-200 dark:text-gray-600"
                          >
                            <div class="flex items-center gap-2">
                              <div
                              ...
                              ></div>
                              <span
                                class="font-medium text-white dark:text-gray-900"
                                >正常：请求正常处理</span
                              >
                            </div>
                            <div class="flex items-center gap-2">
                        ...
                        <div class="space-y-2">
                          ...
                          <div class="text-gray-200 dark:text-gray-600">
                            进度条分别展示 5h
                            与周限窗口的额度使用比例，颜色含义与上方保持一致。
                          </div>
                          <div
                            class="space-y-1 text-gray-200 dark:text-gray-600"
                          >
                            <div class="flex items-start gap-2">
                              <i
                                class="fas fa-clock mt-[2px] text-[10px] text-blue-500"
                              ></i>
                              <span
                                class="font-medium text-white dark:text-gray-900"
                                >5h
                                窗口：5小时使用量进度，到达重置时间后会自动归零。</span
                              >
                            </div>
                            <div class="flex items-start gap-2">
                              <i
                                class="fas fa-history mt-[2px] text-[10px] text-emerald-500"
                              ></i>
                              <span
                                class="font-medium text-white dark:text-gray-900"
                                >周限窗口：7天使用量进度，重置时同样回到
                                0%。</span
                              >
                            </div>
                            <div class="flex items-start gap-2">
                        ...
                        <div class="space-y-2">
                          ...
                          >
                            <div class="flex items-start gap-2">
                              <i
                                class="fas fa-clock mt-[2px] text-[10px] text-indigo-500"
                              ></i>
                              <span
                                class="font-medium text-white dark:text-gray-900"
                            ...
                            <div class="flex items-start gap-2">
                              <i
                                class="fas fa-gem mt-[2px] text-[10px] text-purple-500"
                              ></i>
                              <span
                                class="font-medium text-white dark:text-gray-900"
                            ...
                            <div class="flex items-start gap-2">
                              <i
                                class="fas fa-sync-alt mt-[2px] text-[10px] text-blue-500"
                              ></i>
                              <span
                                class="font-medium text-white dark:text-gray-900"
                                >到达重置时间后自动归零。</span
            ...
            >
              ...
              <td class="px-3 py-4">
                <div class="flex items-center gap-1">
                  ...
                  >
                    <div class="fa-openai" />
                    <span class="text-xs font-semibold text-gray-950"
                      >OpenAi</span
                    >
                  ...
                  >
                    <i
                      class="fab fa-microsoft text-xs text-blue-700 dark:text-blue-400"
                    />
                    <span
                  ...
                  >
                    <i
                      class="fas fa-server text-xs text-teal-700 dark:text-teal-400"
                    />
                    <span
                  ...
                  >
                    <i
                      class="fas fa-robot text-xs text-cyan-700 dark:text-cyan-400"
                    />
                    <span
                ...
                <div class="flex flex-col gap-1">
                  ...
                  >
                    ...
                    <span
                      ...
                      >({{
                        formatRateLimitTime(
                          account.rateLimitStatus.minutesRemaining,
                        )
                      }})</span
                    >
                  </span>
                  ...
                  >
                    ...
                    >
                      <i
                        class="fas fa-question-circle ml-1 cursor-help text-gray-500"
                      />
                    </el-tooltip>
                  </span>
                  <span
              ...
              <td class="whitespace-nowrap px-3 py-4">
                <div class="flex flex-col gap-1.5">
                  <!-- 定时任务状态 -->
                  <div
                    v-if="account.scheduledRequest?.enabled"
                    class="space-y-1"
                  >
                    <div class="flex items-center gap-1.5 text-xs">
                      ...
                      >
                        ...
                        {{
                          String(
                            account.scheduledRequest.scheduleHour || 7,
                          ).padStart(2, "0")
                        }}:05
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <el-tooltip
                        v-else-if="
                          account.scheduledRequest.lastStatus === 'error'
                        "
                        :content="
                          account.scheduledRequest.lastError || '执行失败'
                        "
                        effect="dark"
                        placement="top"
                      >
                    ...
                    >
                      {{
                        formatRelativeTime(
                          account.scheduledRequest.lastExecutedAt,
                        )
                      }}
                    </div>
                  </div>
              ...
              <td class="whitespace-nowrap px-3 py-4">
                ...
                >
                  ...
                  <span
                    class="min-w-[20px] text-xs font-medium text-gray-700 dark:text-gray-200"
                  >
                    {{ account.priority || 50 }}
                  </span>
                </div>
              ...
              <td class="whitespace-nowrap px-3 py-4 text-sm">
                ...
                >
                  ...
                  <div
                    v-if="
                      account.usage.averages && account.usage.averages.rpm > 0
                    "
                    class="text-xs text-gray-500 dark:text-gray-400"
                  >
              ...
              <td class="whitespace-nowrap px-3 py-4">
                <div v-if="account.platform === 'claude'" class="space-y-2">
                    ...
                    <div class="rounded-lg bg-gray-50 p-2 dark:bg-gray-700/70">
                      <div class="flex items-center gap-2">
                        ...
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                            <div
                              class="h-2 flex-1 rounded-full bg-gray-200 dark:bg-gray-600"
                            >
                              <div
                                :class="[
                  ...
                  >
                    ...
                    >
                      <div class="flex items-center gap-1">
                        ...
                        >
                          {{
                            formatNumber(
                              account.usage.sessionWindow.totalTokens,
                            )
                          }}M
                        </span>
                      </div>
                    ...
                    <div class="flex items-center gap-2">
                      <div
                        class="h-2 w-24 rounded-full bg-gray-200 dark:bg-gray-700"
                      >
                        <div
                          :class="[
                            'h-2 rounded-full transition-all duration-300',
                    ...
                    <div class="text-xs text-gray-600 dark:text-gray-400">
                      ...
                      >
                        ...
                        {{
                          formatRemainingTime(
                            account.sessionWindow.remainingTime,
                          )
                        }}
                      </div>
                    </div>
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        >
                          <div
                            ...
                            :style="{
                              width:
                                Math.min(100, getQuotaUsagePercent(account)) +
                                '%',
                            }"
                          />
                        </div>
                        ...
                        <div
                          :class="[
                            ...
                            getConcurrencyBarClass(
                              getConsoleConcurrencyPercent(account),
                            ),
                          ]"
                          :style="{
                            width:
              ...
              <td
                class="whitespace-nowrap px-3 py-4 text-sm text-gray-600 dark:text-gray-300"
              >
              ...
              <td class="whitespace-nowrap px-3 py-4 text-sm font-medium">
                <div class="flex flex-wrap items-center gap-1">
                  <button
                    ...
                    :title="
                      account.isResetting ? '重置中...' : '重置所有异常状态'
                    "
                  ...
                  >
                    <i
                      :class="[
                        'fas fa-redo',
                        account.isResetting ? 'animate-spin' : '',
                      ]"
                    />
                  ...
                  <button
                    ...
                    :title="
                      account.schedulable ? '点击禁用调度' : '点击启用调度'
                    "
      ...
      >
        ...
        >
          ...
          <div class="mb-3 space-y-2">
            ...
            <!-- 定时任务 -->
            <div class="flex items-center justify-between text-xs">
              <span class="text-gray-500 dark:text-gray-400">定时任务</span>
              <div class="flex flex-col items-end gap-1">
                ...
                <div
                  v-if="
                    account.scheduledRequest?.enabled &&
                    account.scheduledRequest.lastExecutedAt
                  "
          ...
          <div class="mt-3 flex gap-2 border-t border-gray-100 pt-3">
            ...
            >
              <i
                :class="['fas', account.schedulable ? 'fa-pause' : 'fa-play']"
              />
    ...
    <AccountForm
      v-if="
        ...
        (!newAccountPlatform || newAccountPlatform !== 'ccr')
      "
...
const canViewUsage = (account) =>
  !!account && supportedUsagePlatforms.includes(account.platform);
...
const showTrailingEllipsis = computed(() => {
  ...
  if (pages.length === 0) return false;
  return (
    shouldShowLastPage.value && pages[pages.length - 1] < totalPages.value - 1
  );
});
...
const handleSelectAll = () => {
  if (selectAllChecked.value) {
    ...
    const currentIds = new Set(
      paginatedAccounts.value.map((account) => account.id),
    );
...
const loadAccounts = async (forceReload = false) => {
  ...
  try {
    ...
    if (claudeConsoleData.success) {
      const claudeConsoleAccounts = (claudeConsoleData.data || []).map(
        (acc) => {
    ...
    if (openaiResponsesData && openaiResponsesData.success) {
      const openaiResponsesAccounts = (openaiResponsesData.data || []).map(
        (acc) => {
    ...
    if (groupFilter.value !== "all") {
      if (groupFilter.value === "ungrouped") {
        ...
        filteredAccounts = allAccounts.filter((account) => {
          ...
          // 检查账户是否属于选中的分组
          return account.groupInfos.some(
    ...
    filteredAccounts = filteredAccounts.map((account) => {
      const proxyConfig = normalizeProxyData(
        account.proxyConfig || account.proxy,
      );
      return {
        ...account,
...
const sortAccounts = (field) => {
  if (field) {
    if (accountsSortBy.value === field) {
      accountsSortOrder.value =
        accountsSortOrder.value === "asc" ? "desc" : "asc";
    } else {
...
function normalizeProxyData(proxy) {
  ...
  const candidate =
    proxyObject.proxy && typeof proxyObject.proxy === "object"
      ? proxyObject.proxy
      : proxyObject;
  ...
  const port =
    candidate.port !== undefined && candidate.port !== null
...
const formatProxyDisplay = (proxy) => {
  ...
  const typeShort =
    parsed.type.toLowerCase() === "socks5" ? "S5" : parsed.type.toUpperCase();
...
const batchDeleteAccounts = async () => {
  ...
  if (failedCount > 0) {
    const detailMessage = failedDetails
...
const getDroidAuthType = (account) => {
  ...
  const apiKeyModeFlag =
    account.isApiKeyMode ??
    account.is_api_key_mode ??
    account.apiKeyMode ??
    account.api_key_mode;
...
const normalizeCodexUsagePercent = (usageItem) => {
  ...
  const basePercent =
    typeof usageItem.usedPercent === "number" &&
    !Number.isNaN(usageItem.usedPercent)
      ? usageItem.usedPercent
      : null;

  const resetAfterSeconds =
    typeof usageItem.resetAfterSeconds === "number" &&
    !Number.isNaN(usageItem.resetAfterSeconds)
      ? usageItem.resetAfterSeconds
      : null;

  const remainingSeconds =
    typeof usageItem.remainingSeconds === "number"
