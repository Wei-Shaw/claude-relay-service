<template>
  <div class="mb-4 sm:mb-6">
    <!-- 移动端下拉选择器 -->
    <div
      class="block border border-gray-200 bg-white p-2 dark:border-gray-700 dark:bg-gray-800 sm:hidden"
    >
      <select
        class="w-full rounded-md border border-gray-200 bg-white px-4 py-3 font-semibold text-gray-700 focus:border-black focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-gray-500"
        :value="activeTab"
    ...
    <!-- 桌面端标签栏 -->
    <div
      class="hidden flex-wrap gap-2 border-b border-gray-200 bg-white pb-0 dark:border-gray-700 dark:bg-gray-900 sm:flex"
    >
      <button
        v-for="tab in tabs"
        :key="tab.key"
