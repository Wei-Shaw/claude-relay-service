<template>
  <ModalTransition>
    ...
    >
      <div
        class="modal-panel relative top-20 mx-auto w-96 rounded-md border bg-white p-5 shadow-lg"
      >
        <div class="mt-3">
                ...
                <div class="space-y-2">
                  <label class="flex items-center">
                    ...
                    <div class="ml-3">
                      ...
                      <div class="text-sm text-gray-500">Regular user with basic permissions</div>
                    </div>
                  </label>
                  <label class="flex items-center">
                    <input
                    ...
                    <div class="ml-3">
                      ...
                      <div class="text-sm text-gray-500">
                        Full access to manage users and system
                      </div>
                    </div>
                  </label>
                </div>
