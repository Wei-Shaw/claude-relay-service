  ...
  <div class="api-input-wide-card mb-8 rounded-3xl p-6 shadow-xl">
    ...
    <div class="wide-card-title mb-6">
      <h2 class="mb-2 text-2xl font-bold text-gray-900 dark:text-gray-200">
        ...
        {{ t('apiStats.usageQueryTitle') }}
      </h2>
      <p class="text-base text-gray-600 dark:text-gray-400">
        {{ t('apiStats.usageQueryDescription') }}
      </p>
    </div>
    ...
    <div class="mx-auto max-w-4xl">
      ...
      <div class="control-bar mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          {{ multiKeyMode ? t('apiStats.multiApiKeysLabel') : t('apiStats.singleApiKeyLabel') }}
        </label>
      ...
      <div class="api-input-grid grid grid-cols-1 gap-4 lg:grid-cols-4">
        ...
        <div class="lg:col-span-3">
          ...
          <div v-if="!multiKeyMode" class="relative">
            <input
              ...
              :disabled="loading"
              :placeholder="t('apiStats.singleApiKeyPlaceholder')"
          ...
          <div v-else class="relative">
            <textarea
              ...
              :disabled="loading"
              :placeholder="t('apiStats.multiApiKeysPlaceholder')"
              rows="4"
        ...
        <div class="lg:col-span-1">
          ...
          >
            ...
            {{ loading ? t('apiStats.querying') : t('apiStats.queryStats') }}
          </button>
        </div>
      </div>
      ...
      <div class="security-notice mt-4">
        ...
        {{ multiKeyMode ? t('apiStats.multiSecurityNotice') : t('apiStats.singleSecurityNotice') }}
      </div>
