                ...
                <div class="mt-3">
                  ...
                  <div class="rounded-md border border-green-300 bg-white p-3">
                    <div class="flex items-center justify-between">
                      ...
                      <button
                        class="ml-3 inline-flex flex-shrink-0 items-center rounded border border-transparent bg-green-100 px-2 py-1 text-sm font-medium text-green-700 hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
