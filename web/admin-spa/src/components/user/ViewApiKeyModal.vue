<template>
  <ModalTransition>
    ...
    >
      <div
        class="modal-panel relative top-20 mx-auto w-[768px] max-w-4xl rounded-md border bg-white p-5 shadow-lg"
      >
        <div class="mt-3">
            ...
            <div>
              ...
              <div class="mt-1 flex items-center space-x-2">
                ...
                <div class="flex flex-col space-y-1">
                  <button
                    v-if="apiKey.key"
                    class="inline-flex items-center rounded border border-gray-300 bg-white px-2 py-1 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              ...
              <p v-if="!apiKey.key" class="mt-1 text-sm text-gray-500">
